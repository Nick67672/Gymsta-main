...
import { DebugSharing } from '../../components/DebugSharing';
import { DebugMessagingSharing } from '../../components/DebugMessagingSharing';
...
export default function HomeScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      {/* Temporary debug component for testing sharing functionality */}
      {isAuthenticated && <DebugSharing />}
      
      {/* Debug component for testing messaging and sharing */}
      {isAuthenticated && <DebugMessagingSharing />}
